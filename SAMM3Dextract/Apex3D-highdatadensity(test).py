...
def apexGo():
        for i in pathList:
                ...
                apexGoPath = '{} -pRawDirName "{}" -outputDirName "{}" -outputUserDirName "{}" -leThresholdCounts 10 -heThresholdCounts 10 -lockMassZ1 556.2771  -msOnly 0 -bRawCSVOutput 1 -'.format(apexPath, i, outputDir, outputDir)
