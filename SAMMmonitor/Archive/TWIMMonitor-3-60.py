...
Script modified for EJ3-60 APEXOUT export from SAMMMonitor-121219.py
"""
import os
import csv
import sys
...
def check_hit(hit_mz, hit_mobility, target_data,
    ...
    if mz_units != 'abs':
        ...
        if mz_tolerance > 1: 
            raise Exception(f'you messed up, m/z tolerance is set as percentage but can\'t be - either set mz_units to \'abs\', not this: {mz_units} or change mz_tolerance to decimal fraction')
...
data_folder = r'E:\3-Work\SAMM\Experimental Data\EJ3-60-SAMM3-MoMonitoring\EJ3-60-BA1 Files\EJ3-60-BA1'
    #system path of .RAW Data folders
...
#mz_units set to 'abs' as default for absolute mz_tolerance. If not 'abs' (i.e. None or whatever else, mz_tolerance is read as decimal fraction)
